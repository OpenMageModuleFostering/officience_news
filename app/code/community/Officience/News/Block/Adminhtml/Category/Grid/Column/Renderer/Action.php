...
class Officience_News_Block_Adminhtml_Category_Grid_Column_Renderer_Action extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Text {
            ...
            switch ($attibute) {
                ...
                case 'url':
                    if (is_array($action['url'])) {
                        $params = array($action['field'] => $row->getCategoryId());
